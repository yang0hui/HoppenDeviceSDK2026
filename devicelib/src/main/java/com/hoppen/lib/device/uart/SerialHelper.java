package com.hoppen.lib.device.uart;
...
import com.hoppen.lib.device.uart.stick.SpecifiedStickPackageHelper;
import com.hoppen.lib.device.uart.utils.ByteUtil;
...
//                    }
    ...
    private AbsStickPackageHelper mStickPackageHelper = new SpecifiedStickPackageHelper("<[".getBytes(), "]>".getBytes());
